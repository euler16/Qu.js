...
import { randomStr, formatComplex, zeroes, identityMatrix, makeControlled } from './Helper'; 
...
class QuantumCircuit {
    ...
    */
    ...
    removeGate(column: number, wire: number): void {
        ...
        let gate: Gate = this.gates[wire][column];
        // assuming this is the same as one for which interface was declared
        if (!gate) {
            return;
        }
